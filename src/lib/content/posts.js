// Blog posts. Content is trusted, first-party HTML rendered with {@html}.
// Newest first. `date` is ISO (YYYY-MM-DD).
...
export const posts = [
  {
    ...
    body: `
      ...
      <h2>What a proper service includes</h2>
      <ul>
        <li>Testing and balancing chlorine, pH, and alkalinity</li>
        <li>Skimming, brushing, and vacuuming</li>
        <li>Emptying weir and pump baskets</li>
        <li>Backwashing and rinsing the filter</li>
        <li>Checking the pump, filter, and cleaner are working properly</li>
      </ul>
  ...
  {
    slug: 'green-pool-how-to-get-it-clear',
    title: "Green Pool? Here's How to Get It Clear Again",
    description:
      'A green pool looks like a disaster, but most can be recovered without draining. Here is what causes it and how a green-to-clean recovery actually works.',
    date: '2026-07-30',
    category: 'Pool Care',
    ...
    body: `
      ...
      <ol>
        <li><strong>Balance and shock.</strong> We test the water, correct the pH, and shock the pool with chlorine to kill the algae.</li>
        <li><strong>Filter, filter, filter.</strong> Dead algae has to be filtered out. This is where the pump and filter earn their keep, running long hours and being backwashed as they clog.</li>
        <li><strong>Brush and vacuum.</strong> Algae clings to surfaces, so brushing the walls and floor and vacuuming out the debris is essential.</li>
        <li><strong>Re-test and stabilise.</strong> Once the water clears, we re-balance everything so it stays clear.</li>
      </ol>
  ...
  {
    slug: 'waterproofing-before-summer-rains-checklist',
    title: "Waterproofing Before the Summer Rains: A Homeowner's Checklist",
    description:
      'Gauteng summer storms find every weak point in your roof and walls. Use this checklist to waterproof your home before the rains arrive.',
    date: '2026-07-12',
    ...
    body: `
      ...
      <p>Blocked gutters overflow back into the roof and walls. Clearing leaves and debris before the rains is one of the cheapest, highest-value maintenance jobs you can do.</p>

      <h2>Check balconies, parapets, and walls</h2>
      ...
      <p>Want a professional check before the rains? <a href="/services/waterproofing">See our waterproofing service</a> or <a href="/#contact">book an inspection</a>.</p>
    `
  },
  {
  ...
  {
    slug: '5-signs-your-pool-pump-needs-attention',
    title: '5 Signs Your Pool Pump Needs Attention',
    description:
      'The pump is the heart of your pool. Here are five warning signs that your pool pump needs a service or replacement before it fails completely.',
    date: '2026-06-05',
    category: 'Pool Care',
    ...
    body: `
      ...
      <p>Noticing any of these? <a href="/services/pump-installations">See our pump service</a> or <a href="/#contact">book a look</a>.</p>
    `
  }
];
